    ...
    layui.use(['table', 'form', 'layer', 'vip_table'], function () {
        ...
        var tableIns = table.render({
            ...
            cols: [[                  //标题栏
                ...
                , {field: 'del', title: '状态', width: 100, align: 'center'}
                , {field: 'is_del', title: '是否开启状态', width: 100, align: 'center'}
                , {field: 'flirt', title: '调戏功能', width: 100, align: 'center'}
                , {field: 'is_flirt', title: '是否开启调戏功能', width: 100, align: 'center'}
