...
function GetCookie(name) {
    ...
    if (arr == null && name == "robot_token") {
        window.location.href = '../robot/login.html';
        return;
    }else {
...
//Log in with phone
function PhoneLogin(cellphone, pass_word_hash, suc_func, error_func) {
...
//get group list
function GroupList(token, suc_func, error_func) {
...
//add group
function Group_add(token,group_name,del,flirt, suc_func, error_func) {
...
//edit group
function Group_edit(token, group_id,group_name,del,flirt, suc_func, error_func) {
...
//get group info
function GetGroupInfo(token, group_id, suc_func, error_func) {
...
//get timer list
function TimerList(token, suc_func, error_func) {
...
//add group
function TimerAdd(token, time, group_id, content, suc_func, error_func) {
...
//edit timer
function Timer_edit(token, timer_id, time, group_id, content, suc_func, error_func) {
...
//get timer info
function GetTimerInfo(token, timer_id, suc_func, error_func) {
    var api_url = 'timer_info.php',
        post_data = {
            'token': token,
            'timer_id':timer_id
        };
...
//delete timer
function DelTimer(token, timer_id, suc_func, error_func) {
