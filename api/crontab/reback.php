...
function reback()
{
    ...
    $sql = "select tx_amount/100000000 as amount,credit_id as us_id from com_base_balance where tx_amount/100000000 <= 20 and tx_type = 'give_like' and substr(ctime,1,10) = '2019-01-01' and debit_id ='50D2910C-6C38-344F-9D30-3289F945C2A6' order by ctime desc";
    $db->query($sql);
    $res_one = $db->fetchAll();
