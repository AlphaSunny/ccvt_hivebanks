...
//用户之前转账撤回
$sql = "select credit_id as us_id,debit_id as transfer_us_id,flag,tx_amount as send_money,utime as ctime,tx_detail as detail from com_transfer_request2 WHERE flag=16 AND give_or_receive=1";
$db->query($sql);
