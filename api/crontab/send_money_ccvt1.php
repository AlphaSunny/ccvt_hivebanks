...
$day_start = strtotime(date('2019-01-05 08:00:00')); //早上八点
$day_end = strtotime(date('2019-01-05 22:00:00'));    //晚上十点
...
//查询所有能送ccvt的群组
$sql = "select * from bot_group WHERE id=23";
$db->query($sql);
$groups = $db->fetchAll();
if ($groups){
    ...
    foreach ($groups as $a=>$b){
        ...
        if ($rows){
            foreach ($rows as $k=>$v){
                ...
                $d['is_replacement'] = 0;
                $d['send_time'] = "2019-01-05 22:11:05";
                $d['bot_create_time'] = '1546697465';
                $lgn_type = 'phone';
                ...
                $data['ctime'] = '1546697465';
                $data['utime'] = "2019-01-05 22:11:05";
                ...
                $dat['ctime'] = '1546697465';
                $dat['utime'] = "2019-01-05 22:11:05";
                ...
                $com_balance_us["utime"] = '1546697465';
                $com_balance_us["ctime"] = "2019-01-05 22:11:05";
                ...
                $com_balance_ba["utime"] = '1546697465';
                $com_balance_ba["ctime"] = "2019-01-05 22:11:05";
...
function send_money_if($ba_id,$wechat){
    $db = new DB_COM();
    $start = strtotime(date('2019-01-05 00:00:00'));
    $end = strtotime(date('2019-01-05 23:59:59'));
