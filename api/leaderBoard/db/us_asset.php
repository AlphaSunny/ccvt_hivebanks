...
function give_like_us($data)
{
    ...
    $com_balance_us['prvs_hash'] = $prvs_hash==0 ? $com_balance_us['hash_id'] : $prvs_hash;var_dump($com_balance_us['prvs_hash']);var_dump($com_balance_us['hash_id']);var_dump($prvs_hash);die;
