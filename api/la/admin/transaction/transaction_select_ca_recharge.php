...
// 记录数组总数
$total = get_us_ca_recharge_log_balance_limt_total($from_time,
    $to_time,
    $ca_id,
    $qa_id,
    $us_id,
...
foreach ($recharge_rows_ca as $k=>$v){
    $recharge_rows_ca[$k]['tx_time'] = date("Y-m-d H:i:s",$v['tx_time']);
}
