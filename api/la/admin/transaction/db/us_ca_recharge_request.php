...
//======================================
function  get_ca_recharge_log_balance_total()
{
    $db = new DB_COM();
...
//         ca_account_id            代理商账号ID（Hash）
//======================================
function  get_ca_recharge_log_balance($offset,$limit)
{
    $db = new DB_COM();
    $sql = "SELECT * FROM us_ca_recharge_request limit $offset,$limit";
    $db -> query($sql);
    $rows = $db -> fetchAll();
    return $rows;
}
...
function get_us_ca_recharge_log_balance_limt_total($from_time,
                                             $to_time,
                                             $ca_id,
                                             $qa_id,
                                             $us_id,
