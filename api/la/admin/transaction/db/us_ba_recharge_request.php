...
//======================================
function  get_ba_recharge_log_balance_total()
{
    $db = new DB_COM();
...
//         ba_account_id            代理商账号ID（Hash）
//======================================
function  get_ba_recharge_log_balance($offset,$limit)
{
    $db = new DB_COM();
    $sql = "SELECT * FROM us_ba_recharge_request limit $offset,$limit";
    $db -> query($sql);
    $rows = $db -> fetchAll();
    return $rows;
}
...
function get_us_ba_recharge_log_balance_limt_total($from_time,
                                             $to_time,
                                             $ba_id,
                                             $qa_id,
                                             $us_id,
